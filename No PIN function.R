no_pin_function <- function() {
  ...
  #Export csv file
  write.csv(pivot_summary, paste0("C:/Users/Josh.Andrews/OneDrive - Department of Health and Social Care/Nurse Data/Outputs/NMC Pins/PIN Errors/",substr(df$Tm_Year_Month,1,8)[1],".csv"))
